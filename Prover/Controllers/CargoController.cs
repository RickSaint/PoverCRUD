...
namespace Prover.Controllers
{
    public class CargoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Ativo")] Cargo cargo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,Ativo")] Cargo cargo)
        {
            if (id != cargo.Id)
            {
                return NotFound();
